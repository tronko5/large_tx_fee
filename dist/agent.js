...
var PANCAKE_FACTORY_CONTRACT = "0xcA143Ce32Fe78f1f7019d7d551a6402fC5350c73";
...
var handleTransaction = function (txEvent) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        findings = [];
        if (txEvent.transaction.to === PANCAKE_FACTORY_CONTRACT) {
            findings.push(forta_agent_1.Finding.fromObject({
                name: "Pool created",
                description: "Created pull " + txEvent.receipt.contractAddress + ".",
                alertId: "FORTA-102",
